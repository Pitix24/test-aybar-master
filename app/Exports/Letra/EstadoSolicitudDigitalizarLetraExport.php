...
class EstadoSolicitudDigitalizarLetraExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping
{
    ...
    {
        $query = EstadoSolicitudDigitalizarLetra::query();
