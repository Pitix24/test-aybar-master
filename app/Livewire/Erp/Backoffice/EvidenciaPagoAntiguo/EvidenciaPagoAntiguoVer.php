...
#[Title('Ver Evidencia Pago Stock')]
class EvidenciaPagoAntiguoVer extends Component
{
    ...
    {
        return view('livewire.erp.backoffice.evidencia-pago-antiguo.evidencia-pago-antiguo-ver');
    }
