...
Route::group(['middleware' => ['permission:modulo-soporte.ver']], function () {
    ...
    Route::group(['middleware' => ['permission:soporte.supervisor']], function () {
        Route::prefix('tipo-soporte')
            ...
            ->group(function () {
                Route::get('/', TipoSoporteLista::class)->middleware('permission:soporte.supervisor')->name('lista');
                Route::get('/ver/{id}', TipoSoporteVer::class)->middleware('permission:soporte.supervisor')->name('ver');
                Route::get('/crear', TipoSoporteCrear::class)->middleware('permission:soporte.supervisor')->name('crear');
                Route::get('/editar/{id}', TipoSoporteEditar::class)->middleware('permission:soporte.supervisor')->name('editar');
            });
    });
    ...
    Route::group(['middleware' => ['permission:soporte.supervisor']], function () {
        Route::prefix('prioridad-soporte')
            ...
            ->group(function () {
                Route::get('/', PrioridadSoporteLista::class)->middleware('permission:soporte.supervisor')->name('lista');
                Route::get('/ver/{id}', PrioridadSoporteVer::class)->middleware('permission:soporte.supervisor')->name('ver');
                Route::get('/crear', PrioridadSoporteCrear::class)->middleware('permission:soporte.supervisor')->name('crear');
                Route::get('/editar/{id}', PrioridadSoporteEditar::class)->middleware('permission:soporte.supervisor')->name('editar');
            });
    });
    ...
    Route::group(['middleware' => ['permission:soporte.supervisor']], function () {
        Route::prefix('estado-soporte')
            ...
            ->group(function () {
                Route::get('/', EstadoSoporteLista::class)->middleware('permission:soporte.supervisor')->name('lista');
