...
use App\Http\Controllers\Erp\Marketing\ClienteDocumentoController;
...
Route::group(['middleware' => ['permission:modulo-marketing.ver']], function () {
    ...
    Route::group(['middleware' => []], function () {
        Route::prefix('cliente-documento')->name('cliente-documento.vista.')->group(function () {
            ...
            Route::get('/stream/{id}', [ClienteDocumentoController::class, 'stream'])->middleware('permission:cliente-documento.lista')->name('stream');
        });
    });
});
