        ...
        <div class="g_contenedor_columna">
            ...
            <div class="g_panel" style="margin-top: 20px;">
                ...
                <div class="informacion_resumen_grid">
                    ...
                    <div class="informacion_resumen_item" style="grid-column: span 2;">
                        ...
                        <span class="informacion_resumen_valor">{{ $reclamo_registrado->cliente_nombre ?: 'N/D'
                            }}</span>
                    </div>
                    <div class="informacion_resumen_item">
                    ...
                    <div class="informacion_resumen_item">
                        ...
                        <span class="informacion_resumen_valor">{{ $reclamo_registrado->proyecto?->nombre ?: 'N/D'
                            }}</span>
                    </div>
                    <div class="informacion_resumen_item">
                    ...
                    @endif
                    {{-- si se detecta al cliente como menor de edad --}}
                    ...
                    <div class="informacion_resumen_item">
                        ...
                        <span class="informacion_resumen_valor">{{
                            $reclamo_registrado->representante_legal_apellido_paterno ?: 'N/D' }}</span>
                    </div>
                    <div class="informacion_resumen_item">
                        <span class="informacion_resumen_label">Apellido materno del representante legal</span>
                        <span class="informacion_resumen_valor">{{
                            $reclamo_registrado->representante_legal_apellido_materno ?: 'N/D' }}</span>
                    </div>
                    @endif
                </div>
            ...
            <form wire:submit.prevent="registrar" class="g_gap_pagina formulario">
                ...
                <div class="g_panel">
                    ...
                    @if($unidad_razon_social && $proyecto_id)
                    <div class="g_margin_top_20 g_panel"
                        ...
                        <div class="informacion_resumen_grid">
                            ...
                            <div class="informacion_resumen_item">
                                <span class="informacion_resumen_label">Región</span>
                                <span class="informacion_resumen_valor">{{ $unidad_region_nombre ?: 'N/D' }}</span>
                            </div>
                            <div class="informacion_resumen_item">
                                <span class="informacion_resumen_label">Provincia</span>
                                <span class="informacion_resumen_valor">{{ $unidad_provincia_nombre ?: 'N/D' }}</span>
                            </div>
                            <div class="informacion_resumen_item">
                                <span class="informacion_resumen_label">Distrito</span>
                                <span class="informacion_resumen_valor">{{ $unidad_distrito_nombre ?: 'N/D' }}</span>
                            </div>
                        </div>
                    </div>
                    @endif
