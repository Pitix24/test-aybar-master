        ...
        @if (!$enviado)
            ...
            <div class="ef_body">
                <div class="text-center mb-6">
                    <h2 class="text-3xl font-bold text-[#004d55] mb-2" style="font-family: 'Outfit', sans-serif;">¡Hola, {{ $copropietario->nombres }}!</h2>
                    <p class="text-gray-600" style="font-size: 1.1rem;">
                        Has sido registrado(a) como <span class="font-bold italic">copropietario(a)</span>. ¿Te gustaría participar en nuestro gran evento?
                    </p>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="ef_btn_group" style="display: grid; grid-template-columns: 1fr; gap: 15px;">
                        <button wire:click="guardarInteres('si')" 
                                class="ef_btn_choice active_si" 
                                style="width: 100%; padding: 20px; text-transform: uppercase; font-weight: 800; border: none; cursor: pointer;">
                            SÍ, estoy interesado(a)
                        </button>
                        <button wire:click="guardarInteres('no')" 
                                class="ef_btn_choice" 
                                style="width: 100%; padding: 20px; text-transform: uppercase; font-weight: 800; border: none; cursor: pointer; background: #e5ddd0; color: #8e8271;">
                            NO podré participar
                        </button>
                    </div>
                </div>
