<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Estado de Solicitud de Digitalización</h2>

        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.estado-solicitud-digitalizar-letra.vista.todo') }}" class="g_boton g_boton_light">
                Lista <i class="fa-solid fa-list"></i></a>

            <a href="{{ route('erp.estado-solicitud-digitalizar-letra.vista.crear') }}" class="g_boton g_boton_primary">
                Crear <i class="fa-solid fa-square-plus"></i></a>

            <button type="button" class="g_boton g_boton_danger"
                onclick="alertaEliminarEstadoSolicitudDigitalizarLetra()">
            ...
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="formulario_botones">
                        ...
                        <a href="{{ route('erp.estado-solicitud-digitalizar-letra.vista.todo') }}"
    ...
    @script
    <script>
        window.alertaEliminarEstadoSolicitudDigitalizarLetra = function () {
            Swal.fire({
