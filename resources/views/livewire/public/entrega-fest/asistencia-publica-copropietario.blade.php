        ...
        <div class="form-card">
            @if (!$enviado)
                <div class="form-header">
                    ...
                    <span class="coprop-badge">
                        <i class="fa-solid fa-people-group"></i> Copropietario del lote
                    </span>
                </div>
                ...
                <div class="form-body">
                    ...
                    {{-- Info del copropietario + lote del titular --}}
                    <div class="info-pill">
                        <div class="info-pill-grid">
                            <div>
                                <span class="info-label">Nombre Completo</span>
                                <span class="info-value">{{ $copropietario->nombres }}</span>
                            </div>
                            <div>
                                <span class="info-label">DNI / Documento</span>
                                <span class="info-value">{{ $copropietario->dni }}</span>
                            </div>
                            <div>
                                <span class="info-label">Proyecto</span>
                                <span class="info-value">{{ $copropietario->prospecto?->proyecto?->nombre ?? 'N/A' }}</span>
                            </div>
                            <div>
