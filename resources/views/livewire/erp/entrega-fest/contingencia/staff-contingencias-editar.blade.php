    ...
    <div class="g_fila">
        <div class="g_columna_8">
            <form wire:submit.prevent="update" class="formulario g_panel g_gap_pagina">
                <h4 class="g_panel_titulo"><i class="fa-solid fa-pencil"></i> Datos de la Contingencia</h4>
                ...
                <div class="g_margin_bottom_10">
                    <label>Acción de Respuesta Inmediata <span class="obligatorio"><i
                                class="fa-solid fa-asterisk"></i></span></label>
                    <textarea wire:model="accion" rows="10"
        ...
        <div class="g_columna_4">
            <div class="g_panel">
                ...
                <p class="g_negrita" style="margin:0 0 12px 0;">{{ $contingencia->created_at->format('d/m/Y H:i') }}</p>

                <p class="g_inferior g_mayuscula" style="margin:0 0 4px 0; font-size:10px;">Última Actualización</p>
                <p class="g_negrita" style="margin:0;">{{ $contingencia->updated_at->format('d/m/Y H:i') }}</p>
            </div>
        </div>
    </div>
