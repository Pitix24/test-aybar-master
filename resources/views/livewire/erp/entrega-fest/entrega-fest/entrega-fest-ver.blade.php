<div class="g_gap_pagina">
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Detalles Entrega Fest: <span style="color: var(--color-primary);">#{{ $evento->codigo }}</span></h2>
            ...
            <div class="formulario g_panel">
                ...
                <div class="g_fila">
                    <div class="g_margin_bottom_10 g_columna_6">
                        ...
                        <input type="text" value="{{ $evento->nombre }}" disabled readonly>
                    </div>

                    <div class="g_margin_bottom_10 g_columna_6">
                        <label>Código único</label>
                        <input type="text" value="{{ $evento->codigo }}" disabled readonly>
                    </div>
                </div>

                <div class="g_margin_bottom_10">
                    <label>Descripción del Evento</label>
                    <textarea rows="3" disabled readonly>{{ $evento->descripcion }}</textarea>
                </div>

                <div class="g_fila">
                    <div class="g_margin_bottom_10 g_columna_6">
                        <label>Fecha de Entrega</label>
                        <input type="date" value="{{ $evento->fecha_entrega->format('Y-m-d') }}" disabled readonly>
                    </div>
