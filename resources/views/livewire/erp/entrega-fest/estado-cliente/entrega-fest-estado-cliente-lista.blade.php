<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Estados de Cliente - Entrega Fest</h2>

        <div class="cabecera_titulo_botones">
            @can('prospecto-entrega-fest.editar')
                <a href="{{ route('erp.entrega-fest.estado-cliente.crear') }}" class="g_boton primary">
    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('prospecto-entrega-fest.exportar-filtro')
                ...
                @can('prospecto-entrega-fest.exportar-todo')
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="estado-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('prospecto-entrega-fest.editar')
                                    <a href="{{ route('erp.entrega-fest.estado-cliente.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>

                                    <a href="{{ route('erp.entrega-fest.estado-cliente.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
