<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Crear Estado de Cliente - Entrega Fest</h2>
        ...
        <form wire:submit.prevent="store" class="formulario">
            <div class="g_fila">
                <div class="g_margin_bottom_20 g_columna_6">
                    ...
                    <input type="text" wire:model="nombre" placeholder="Ej: PENDIENTE, EN PROCESO..."
                ...
                <div class="g_margin_bottom_20 g_columna_3">
                    ...
                    <div style="display: flex; gap: 10px; align-items: center;">
                        ...
                        <input type="text" wire:model="color" placeholder="#000000"
            ...
            <div class="g_tab_form_buttons">
                <button type="submit" class="g_boton guardar">
                    Guardar Estado <i class="fa-solid fa-save"></i>
                </button>
            </div>
        </form>
    </div>
