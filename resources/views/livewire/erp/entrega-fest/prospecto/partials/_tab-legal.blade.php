    ...
    <form wire:submit.prevent="updateLegal" class="formulario">
        ...
        <div class="g_fila">
            <div class="g_columna_12 g_margin_bottom_10">
                <label>Adjuntar Contrato Preliminar (PDF) <span class="obligatorio"><i class="fa-solid fa-asterisk"></i></span></label>

                @if($prospecto->hasMedia('contrato-preliminar'))
                    <div class="g_panel" style="background-color: #f0fdf4; border: 1px solid #bbf7d0; margin-bottom: 10px; padding: 10px;">
                        <div class="g_fila g_flex_centro_vertical">
                            <div class="g_columna_8">
                                <p class="g_texto_pequeno" style="color: #166534; margin: 0;">
                                    ...
                                    <a href="{{ $prospecto->getFirstMediaUrl('contrato-preliminar') }}" target="_blank" class="g_link verde" style="font-weight: 600;">
                ...
                <div class="g_input_file_container">
                    <input type="file" wire:model="archivo_contrato_preeliminar" id="archivo_contrato_preeliminar" accept="application/pdf" class="g_input">
