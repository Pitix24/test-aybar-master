    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('canal.accion-exportar-filtro')
                ...
                @can('canal.accion-exportar-todo')
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="canal-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('canal.vista-ver')
                                    <a href="{{ route('erp.canal.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('canal.vista-editar')
                                    <a href="{{ route('erp.canal.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
