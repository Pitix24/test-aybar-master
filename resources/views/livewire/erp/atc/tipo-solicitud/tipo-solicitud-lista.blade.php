<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Lista de Tipos de Solicitud</h2>
            ...
            <table class="g_tabla">
                <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th class="g_celda_centro">Tiempo Solución (Horas)</th>
                    ...
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td class="g_celda_acciones g_celda_centro">
                                <a href="{{ route('erp.tipo-solicitud.vista.editar', $item->id) }}" class="g_accion_editar"
                                    title="Editar">
