<div class="g_gap_pagina">
    <x-loading-overlay wire:loading
        wire:target="buscar, tipo_solicitud_id, activo, perPage, desde, hasta, resetFiltros, exportExcelFiltro, exportExcelTodo, gotoPage, nextPage, previousPage"
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="sub-tipo-{{ $item->id }}">
                            ...
                            <td class="g_celda_centro">
                                ...
                                @else
                                    <span class="leyenda">Herencia</span>
                                @endif
                            </td>
                            <td class="g_celda_centro">
                                @if($item->activo)
