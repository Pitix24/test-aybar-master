    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('prioridad-ticket.accion-exportar-filtro')
                ...
                @can('prioridad-ticket.accion-exportar-todo')
            ...
            <table class="g_tabla">
                <thead>
                    <tr>
                        ...
                        <th>Nombre</th>
                        <th class="g_celda_centro">Tiempo Permitido (H)</th>
                        <th>Color</th>
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="prioridad-{{ $item->id }}">
                            <td class="g_celda_centro">{{ $items->firstItem() + $index }}</td>
                            <td class="g_celda_centro">
                                <i class="{{ $item->icono ?? 'fa-solid fa-flag' }}"
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('prioridad-ticket.vista-ver')
                                    <a href="{{ route('erp.prioridad-ticket.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
