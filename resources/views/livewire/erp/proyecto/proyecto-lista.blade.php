            ...
            <table class="g_tabla">
                <thead>
                    <tr>
                        ...
                        <th>Proyecto</th>
                        <th class="g_celda_centro">ID Slin</th>
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td class="g_celda_centro g_resaltar">{{ $item->slin_id ?? '-' }}</td>
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                <a href="{{ route('erp.proyecto.vista.editar', $item->id) }}" class="g_accion_editar" title="Editar">
