                ...
                <div class="g_panel">
                    ...
                    <div class="g_fila">
                        ...
                        <div class="g_columna_6 g_margin_bottom_10">
                            ...
                            <input type="email" id="email_buzon" wire:model.blur="email_buzon"
                                placeholder="buzon@empresa.com" class="@error('email_buzon') input-error @enderror"
                                autocomplete="off">
                            @error('email_buzon')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="g_fila">
                        ...
                        <div class="g_columna_6 g_margin_bottom_10">
                            ...
                            <input type="text" id="icono" wire:model.blur="icono" placeholder="fa-solid fa-shapes"
