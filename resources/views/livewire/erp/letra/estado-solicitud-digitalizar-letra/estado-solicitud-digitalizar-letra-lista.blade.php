<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Estados de Digitalización de Letra</h2>
    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('estado-solicitud-digitalizar-letra.exportar-filtro')
                ...
                @can('estado-solicitud-digitalizar-letra.exportar-todo')
            ...
            <table class="g_tabla">
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="estado-digitalizacion-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('estado-solicitud-digitalizar-letra.ver')
                                    <a href="{{ route('erp.estado-solicitud-digitalizar-letra.vista.ver', $item->id) }}"
                                ...
                                @can('estado-solicitud-digitalizar-letra.editar')
                                    <a href="{{ route('erp.estado-solicitud-digitalizar-letra.vista.editar', $item->id) }}"
