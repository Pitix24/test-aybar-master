    ...
    <form wire:submit.prevent="update" class="formulario g_panel" x-data="{ activeTab: 'general' }">
        ...
        <div x-show="activeTab === 'general'" x-transition class="g_tab_content">
            <div class="g_fila">
                ...
                <div class="g_columna_4 g_margin_bottom_10">
                    ...
                    <input type="text"
                        value="{{ $clasificacion === 'PENDIENTE_REVISION' ? 'PENDIENTE VERIFICACION' : str_replace('_', ' ', $clasificacion) }}"
                        disabled>
                </div>
            </div>
            ...
            <div class="g_fila">
                <div class="g_columna_4 g_margin_bottom_10">
                    <label>Origen</label>
                    <input type="text"
                        value="{{ $ticket_model->created_by ? 'ERP - Registro Interno' : 'Formulario web' }}" disabled>
                </div>
            ...
            <div class="g_fila">
                <div class="g_columna_12 g_margin_bottom_10">
                    ...
                    <input type="text"
                        value="{{ optional($ticket_model->assigned_at)->format('d/m/Y H:i') ?: 'Sin asignación' }}"
                        disabled>
                </div>
            </div>
            ...
            <div class="g_fila">
                <div class="g_columna_12 g_margin_bottom_10">
                    ...
                    <input type="text"
                        value="{{ $ticket_model->ticketRelacionado ? ('#' . $ticket_model->ticketRelacionado->id) : 'Sin vincular' }}"
                        disabled>
                </div>
            </div>
        </div>
        ...
        <div x-show="activeTab === 'asunto'" x-transition class="g_tab_content">
            ...
            <div class="g_margin_bottom_10">
                ...
                <div class="g_fila">
                    ...
                    <div class="g_columna_4 g_margin_bottom_10">
                        <button type="button" wire:click="agregarLote" class="g_boton guardar"
                            wire:loading.attr="disabled">
        ...
        <div x-show="activeTab === 'auditoria'" x-transition class="g_tab_content">
            <div class="g_fila">
                <div class="g_columna_4 g_margin_bottom_10">
                    <label>Creado</label>
                    <input type="text" value="{{ optional($ticket_model->created_at)->format('d/m/Y H:i') ?: 'N/D' }}"
                        disabled>
                </div>

                <div class="g_columna_4 g_margin_bottom_10">
                    <label>Actualizado</label>
                    <input type="text" value="{{ optional($ticket_model->updated_at)->format('d/m/Y H:i') ?: 'N/D' }}"
                        disabled>
                </div>
