        ...
        <div class="g_columna_4 formulario">
            <div class="g_panel">
                ...
                <div class="formulario_botones g_margin_bottom_10">
                    <button type="button" wire:click="buscarCliente" class="g_boton guardar" wire:loading.attr="disabled" wire:target="buscarCliente">
                ...
                @if ($informaciones->isNotEmpty())
                    ...
                    <div class="formulario_botones">
                        <button type="button" wire:click="agregarLote" class="g_boton guardar" wire:loading.attr="disabled" wire:target="agregarLote">
