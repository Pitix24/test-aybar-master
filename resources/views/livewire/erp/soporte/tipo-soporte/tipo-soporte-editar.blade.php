            ...
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="formulario_botones">
                        @can('tipo-soporte.accion-editar')
                        ...
                        @can('tipo-soporte.accion-eliminar')
                            <button type="button" class="g_boton eliminar"
                                onclick="if(confirm('¿Está seguro que desea eliminar este tipo de soporte?')) { Livewire.dispatch('eliminarTipoSoporteOn'); }"
                                wire:loading.attr="disabled" wire:target="eliminarTipoSoporteOn">
                                <span wire:loading.remove wire:target="eliminarTipoSoporteOn">
                                    <i class="fa-solid fa-trash"></i> Eliminar
                                </span>
                                <span wire:loading wire:target="eliminarTipoSoporteOn">
