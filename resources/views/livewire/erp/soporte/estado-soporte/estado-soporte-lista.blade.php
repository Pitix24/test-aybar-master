<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Estados de Soporte</h2>

        <div class="cabecera_titulo_botones">
            @can('estado-soporte.vista-crear')
                <a href="{{ route('erp.estado-soporte.vista.crear') }}" class="g_boton primary">
            ...
            <table class="g_tabla">
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="estado-soporte-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('estado-soporte.vista-ver')
                                    <a href="{{ route('erp.estado-soporte.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                @endcan

                                @can('estado-soporte.vista-editar')
                                    <a href="{{ route('erp.estado-soporte.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
