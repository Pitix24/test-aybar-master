<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarEstadoSoporteOn" message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Estado de Soporte</h2>
            ...
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="formulario_botones">
                        @can('estado-soporte.accion-editar')
                        ...
                        @can('estado-soporte.accion-eliminar')
                            <button type="button" class="g_boton eliminar"
                                onclick="if(confirm('¿Está seguro que desea eliminar este estado de soporte?')) { Livewire.dispatch('eliminarEstadoSoporteOn'); }"
                                wire:loading.attr="disabled" wire:target="eliminarEstadoSoporteOn">
                                <span wire:loading.remove wire:target="eliminarEstadoSoporteOn">
                                    <i class="fa-solid fa-trash"></i> Eliminar
                                </span>
                                <span wire:loading wire:target="eliminarEstadoSoporteOn">
