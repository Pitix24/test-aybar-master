<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Prioridades de Soporte</h2>

        <div class="cabecera_titulo_botones">
            @can('prioridad-soporte.vista-crear')
                <a href="{{ route('erp.prioridad-soporte.vista.crear') }}" class="g_boton primary">
            ...
            <table class="g_tabla">
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="prioridad-soporte-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('prioridad-soporte.vista-ver')
                                    <a href="{{ route('erp.prioridad-soporte.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('prioridad-soporte.vista-editar')
                                    <a href="{{ route('erp.prioridad-soporte.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
