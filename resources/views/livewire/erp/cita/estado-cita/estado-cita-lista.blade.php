    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('estado-cita.exportar-filtro')
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="estado-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('estado-cita.ver')
                                    <a href="{{ route('erp.estado-cita.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('estado-cita.editar')
                                    <a href="{{ route('erp.estado-cita.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
