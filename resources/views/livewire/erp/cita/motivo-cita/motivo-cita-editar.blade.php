<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarMotivoCitaOn" message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Motivo de Cita</h2>
        ...
        <div class="cabecera_titulo_botones">
            ...
            @can('motivo-cita.eliminar')
                <button type="button" class="g_boton danger" onclick="confirmarEliminarMotivoCita()">
        ...
        <div class="g_fila">
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="g_margin_bottom_10">
                        <label for="nombre">
                            Nombre del Motivo <span class="obligatorio"><i class="fa-solid fa-asterisk"></i></span>
                        </label>
                    ...
                    <div class="g_fila">
                        ...
                        <div class="g_columna_6 g_margin_bottom_10">
                            ...
                            @error('icono')
                                <p class="mensaje_error">{{ $message }}</p>
                            @enderror
                            <p class="leyenda">Ej: fa-solid fa-calendar-check, fa-solid fa-circle-info</p>
                        </div>
                    </div>
    ...
    @script
    <script>
        window.confirmarEliminarMotivoCita = function () {
            Swal.fire({
                title: '¿Quieres eliminar este motivo?',
