<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.motivo-cita.vista.todo') }}" class="g_boton g_boton_light">
                Lista <i class="fa-solid fa-list"></i></a>

            <a href="{{ route('erp.motivo-cita.vista.crear') }}" class="g_boton g_boton_primary">
                Crear <i class="fa-solid fa-square-plus"></i></a>

            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarMotivoCita()">
        ...
        <div class="g_fila">
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="g_margin_bottom_10">
                        <label for="nombre">Nombre del Motivo <span class="obligatorio"><i
                    ...
                    <div class="formulario_botones">
                        ...
                        <a href="{{ route('erp.motivo-cita.vista.todo') }}" class="g_boton g_boton_cancelar">
    ...
    @script
    <script>
        window.alertaEliminarMotivoCita = function () {
            Swal.fire({
