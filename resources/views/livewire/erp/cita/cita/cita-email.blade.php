    ...
    @if(!$soloLectura)
        <div x-show="activeTab === 'enviar'" x-transition class="g_tab_content">
            <div class="formulario">
                @if(!$emailDestino || $emailDestino == 'No registrado')
                    <p class="g_resaltado_indicacion info">
                        <i class="fa-solid fa-info-circle"></i>
                        <span>
                            El cliente <strong>no tiene un email</strong> registrado. No se puede realizar el envío.
                        </span>
                    </p>
                @endif
                ...
                <div class="g_margin_bottom_10">
                    ...
                    <input type="text" value="{{ $emailDestino }}" disabled class="g_input_disabled">
                </div>
                ...
                <div class="g_margin_bottom_20">
                    ...
                    <input type="file" id="citaEmailFileUpload" wire:model="nuevosArchivos" multiple style="display: none;">

                    <div class="contenedor_dropzone"
                        onclick="if(event.target.closest('.dropzone_remove_button')) return; document.getElementById('citaEmailFileUpload').click()">
                        @if($nuevosArchivos)
                            <div>
                ...
                <div class="formulario_botones">
                    @can('cita.enviar-correo')
                        <button class="g_boton guardar" wire:click="store" wire:loading.attr="disabled" @if(!$emailDestino || $emailDestino == 'No registrado') disabled @endif>
