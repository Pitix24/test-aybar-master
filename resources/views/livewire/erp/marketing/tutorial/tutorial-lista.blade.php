        ...
        <div class="formulario">
            <div class="g_fila">
                <div class="g_margin_bottom_10 g_columna_2">
                    <label>Buscar (Título o ID)</label>
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="tutorial-{{ $item->id }}">
                            ...
                            <td class="g_celda_centro">
                                @can('tutorial.ver')
                                    <a href="{{ route('erp.tutorial.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('tutorial.editar')
                                    <a href="{{ route('erp.tutorial.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
