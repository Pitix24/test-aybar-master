            ...
            <table class="g_tabla">
                ...
                <tbody>
                    ...
                    <tr wire:key="doc-{{ $item->id }}">
                        ...
                        <td class="g_celda_centro">
                            @if($item->archivoPdf)
                            <a href="{{ route('erp.cliente-documento.vista.stream', $item->id) }}" target="_blank" class="g_accion ver" title="Ver PDF Original">
                                <i class="fa-solid fa-file-pdf"></i>
                            </a>
                            @endif

                            @can('cliente_documento.editar')
                            <a href="{{ route('erp.cliente-documento.vista.editar', $item->id) }}" class="g_accion editar"
                                title="Editar">
