<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarEstadoSolicitudEvidenciaPagoOn"
        message="Procesando..." />

    <div class="g_panel cabecera_titulo_pagina">
        <h2>Editar Estado de Evidencia de Pago</h2>

        <div class="cabecera_titulo_botones">
            @can('estado-solicitud-evidencia-pago.lista')
                <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.todo') }}" class="g_boton light">
            ...
            @can('estado-solicitud-evidencia-pago.eliminar')
        ...
        window.confirmarEliminarEstado = function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $wire.eliminarEstadoSolicitudEvidenciaPagoOn();
                }
            });
        }
    </script>
