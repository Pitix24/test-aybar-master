<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.todo') }}" class="g_boton g_boton_light">
                Lista <i class="fa-solid fa-list"></i></a>

            <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.crear') }}" class="g_boton g_boton_primary">
                Crear <i class="fa-solid fa-square-plus"></i></a>

            <button type="button" class="g_boton g_boton_danger" onclick="alertaEliminarEstadoSolicitudEvidenciaPago()">
            ...
            <div class="g_columna_8">
                <div class="g_panel">
                    ...
                    <div class="formulario_botones">
                        ...
                        <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.todo') }}"
    ...
    @script
    <script>
        window.alertaEliminarEstadoSolicitudEvidenciaPago = function () {
            Swal.fire({
