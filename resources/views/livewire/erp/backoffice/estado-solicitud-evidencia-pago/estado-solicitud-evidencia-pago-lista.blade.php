<div class="g_gap_pagina">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        <h2>Estados de Evidencia de Pago</h2>

        <div class="cabecera_titulo_botones">
            @can('estado-solicitud-evidencia-pago.crear')
                <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.crear') }}" class="g_boton primary">
    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('estado-solicitud-evidencia-pago.exportar-filtro')
                ...
                @can('estado-solicitud-evidencia-pago.exportar-todo')
            ...
            <table class="g_tabla">
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr wire:key="estado-evidencia-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('estado-solicitud-evidencia-pago.ver')
                                    <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.ver', $item->id) }}"
                                        class="g_accion ver" title="Ver detalle">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                @endcan

                                @can('estado-solicitud-evidencia-pago.editar')
                                    <a href="{{ route('erp.estado-solicitud-evidencia-pago.vista.editar', $item->id) }}"
