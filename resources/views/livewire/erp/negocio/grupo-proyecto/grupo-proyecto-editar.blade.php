<div class="g_gap_pagina">
    <x-loading-overlay wire:loading wire:target="update, eliminarGrupoOn" message="Procesando..." />
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            @can('grupo-proyecto.eliminar')
                <button type="button" class="g_boton danger" onclick="confirmarEliminarGrupo()">
    ...
    @script
    <script>
        window.confirmarEliminarGrupo = function () {
            Swal.fire({
                title: '¿Quieres eliminar este grupo?',
