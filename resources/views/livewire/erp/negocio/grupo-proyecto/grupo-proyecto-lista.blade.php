<div class="g_gap_pagina">
    <x-loading-overlay wire:loading
        wire:target="buscar, activo, desde, hasta, perPage, resetFiltros, exportExcelFiltro, exportExcelTodo, gotoPage, nextPage, previousPage"
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            @can('grupo-proyecto.crear')
                <a href="{{ route('erp.grupo-proyecto.vista.crear') }}" class="g_boton primary">
    ...
    <div class="g_panel">
        <div class="g_tabla_cabecera">
            <div class="g_tabla_cabecera_botones">
                @can('grupo-proyecto.exportar-filtro')
                ...
                @can('grupo-proyecto.exportar-todo')
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="grupo-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('grupo-proyecto.ver')
                                    <a href="{{ route('erp.grupo-proyecto.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('grupo-proyecto.editar')
                                    <a href="{{ route('erp.grupo-proyecto.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
