<div class="g_gap_pagina">
    <x-loading-overlay wire:loading
        wire:target="buscar, activo, unidad_negocio_id, grupo_proyecto_id, desde, hasta, perPage, resetFiltros, exportExcelFiltro, exportExcelTodo, gotoPage, nextPage, previousPage"
                    ...
                    @foreach ($items as $index => $item)
                        <tr wire:key="proyecto-{{ $item->id }}">
                            ...
                            <td class="g_celda_acciones g_celda_centro centro">
                                @can('proyecto.ver')
                                    <a href="{{ route('erp.proyecto.vista.ver', $item->id) }}" class="g_accion ver"
                                        title="Ver detalle">
                                ...
                                @can('proyecto.editar')
                                    <a href="{{ route('erp.proyecto.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
