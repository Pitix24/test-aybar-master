        ...
        <div class="formulario">
            <div class="g_fila">
                <div class="g_columna_2">
                    <label>Buscar (Nombre, Email o ID)</label>
                ...
                <tbody>
                    @foreach ($items as $index => $item)
                        <tr>
                            ...
                            <td class="g_celda_centro">
                                @can('area.ver')
                                    <a href="{{ route('erp.area.vista.ver', $item->id) }}" class="g_accion ver" title="Ver">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                @endcan

                                @can('area.ver-usuarios')
                                    <a href="{{ route('erp.area.vista.user', $item->id) }}" class="g_accion success"
                                        title="Usuarios">
                                        <i class="fa-solid fa-users-gear"></i>
                                    </a>
                                @endcan

                                @can('area.ver-solicitudes')
                                    <a href="{{ route('erp.area.vista.solicitud', $item->id) }}" class="g_accion alerta"
                                ...
                                @can('area.editar')
                                    <a href="{{ route('erp.area.vista.editar', $item->id) }}" class="g_accion editar"
                                        title="Editar">
