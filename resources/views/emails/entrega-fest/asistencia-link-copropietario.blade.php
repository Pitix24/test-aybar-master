...
<body style="margin:0; padding:25px; font-family: Arial, sans-serif; background-color: #f4f7f9;">
    <div
        ...
        <div style="text-align:center; margin-bottom: 20px;">
            <span
                style="display:inline-block; background:#e8eaf6; color:#1a237e; border-radius:20px; padding:4px 16px; font-size:13px; font-weight:600;">
            ...
            <table style="width: 100%; font-size: 14px; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 5px 0; font-weight: bold;">
                        {{ $copropietario->prospecto?->proyecto?->nombre ?? 'N/A' }}
                    </td>
                </tr>
                <tr>
