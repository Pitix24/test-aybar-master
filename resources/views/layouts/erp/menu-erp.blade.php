        ...
        <ul>
            @foreach ($menuPrincipal as $n1)
                <li data-id="{{ $n1->id }}" @click="toogleNivel_1($event, {{ $n1->id }})"
                    ...
                    <a @if ($n1->submenus->isEmpty()) href="{{ $n1->ruta !== '#' ? route($n1->ruta) : '#' }}" @endif>
                        <i class="{{ $n1->icono }}"></i>
                    </a>
                </li>
            @endforeach
                                                                ...
                                                                @foreach ($n3->submenus as $n4)
                                                                    <li>
                                                                        <span class="contenedor_a" data-id="{{ $n4->id }}"
                                                                            ...
                                                                            <a
                                                                                href="{{ $n4->submenus->isNotEmpty() ? 'javascript:void(0)' : route($n4->ruta) }}">
