...
4. Implementar la excepción AYBAR CORP. S.A.C.: dejar el arranque en 0 para todas las empresas y exponer una configuración explícita para AYBAR con valor inicial distinto cuando se defina el número real de continuidad. La configuración debe tener valor por defecto seguro y no romper instalaciones nuevas.
