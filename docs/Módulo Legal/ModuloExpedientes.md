...
### Migraciones
- `database/migrations/2026_05_18_155616_create_expedientes_table.php.php` — *actualizar con campos adicionales*
...
- `routes/erp/libro-reclamacion.php` — Estructura de rutas
